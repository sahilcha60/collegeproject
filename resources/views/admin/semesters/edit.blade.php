...
@section('header_title', 'Edit Semester')
@section('content')
<div class="max-w-lg mx-auto bg-white rounded-lg shadow p-6">
    <h3 class="text-lg font-semibold text-gray-700 mb-6">Edit Semester</h3>
    ...
    <form action="{{ route('admin.semesters.update', $semester) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="start_date" value="{{ old('start_date', $semester->start_date) }}"
        ...
        <div class="mb-6">
            ...
            <input type="date" name="end_date" value="{{ old('end_date', $semester->end_date) }}"
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.semesters.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2 rounded-lg transition">Cancel</a>
        </div>
    </form>
</div>
@endsection
